package com.vitorrafael.service;

import com.vitorrafael.model.User;
import com.vitorrafael.repository.UserRepository;
...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        // hasRole automatically add "ROLE_" before the word, so we have to add it manually here
